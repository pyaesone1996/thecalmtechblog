...
<body>
    <div x-data="{ avatar: false }" class="h-screen flex overflow-hidden bg-cool-gray-100">
              ...
              <div class="ml-4 flex items-center md:ml-6">
                ...
                <div class="ml-3 relative">
                  <div>
                    ...
                    <button @click="avatar = !avatar" @click.away="avatar = false" class="max-w-xs flex items-center text-sm rounded-full focus:outline-none focus:bg-cool-gray-100 lg:p-2 lg:rounded-md lg:hover:bg-cool-gray-100" id="user-menu" aria-label="User menu" aria-haspopup="true">
                  ...
                  x-show="avatar" class="origin-top-right absolute right-0 mt-2 w-48 rounded-md shadow-lg">
                    <div class="py-1 rounded-md bg-white shadow-xs" role="menu" aria-orientation="vertical" aria-labelledby="user-menu">
                      ...
                      document.getElementById('logout-form').submit();" class="block px-4 py-2 text-sm text-cool-gray-700 hover:bg-cool-gray-100 transition ease-in-out duration-150" role="menuitem">Logout</a>
